...
namespace Tyuiu.SherenkovIR.Sprint7.Project.V10.Test
{
    ...
    public sealed class DataServiceTest
    {
        ...
        public void TestFilter()
        {
            ...
            orderManager.AddOrder(new Order { OrderNumber = "3", LastName = "Petrov", FirstName = "Petr", MiddleName = "Petrovich", Index = "654312", City = "St.Peterburg", Address = "Precgistenka 8", PhoneNumber = "8952766667", OrderDate = DateTime.Now, OrderName = "ProductC", Price = 250, Quantity = 3, AccountNumber = "03" });
